...
//		this.isFinishedTransitory = true;
	...
	public String finish(StringBuilder output, double simTime)
	{
		...
		String fileName;
		String outputTimeTraceFileName = "D:/Projects/UPCT-UPC_Project/Results/SurvivalStudy/Internet2/"+this.rsaAlgorithmType.getString()+"/survival_traffic_time_trace_"+Integer.toString(lf)+"_1.txt";
...
//			System.out.println("Service [" + bandwidthInGbpsPerServiceArray[i] + "]: " +connectionBlockingOnConnectionSetup[i]);
		...
		if(incrementalMode.getBoolean())
		{
			...
			{	
				fileName = "D:/Projects/UPCT-UPC_Project/Results/SurvivalStudy/Internet2/"+this.rsaAlgorithmType.getString()+"/survival_traffic_"+Integer.toString(lf)+".txt";
			}
		...
		{
			i++;
			outputTimeTraceFileName = "D:/Projects/UPCT-UPC_Project/Results/SurvivalStudy/Internet2/"+this.rsaAlgorithmType.getString()+"/survival_traffic_time_trace_"+Integer.toString(lf)+"_"+Integer.toString(i)+".txt";
		} 
